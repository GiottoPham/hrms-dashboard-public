...
import {
  useChatParamsHour,
  useChatParamsNumber,
} from '@frontend/state/chart-params'
export const WeekSelect = ({ isHour }: { isHour?: boolean }) => {
  const { chartParamsHour, setChatParamsHour } = useChatParamsHour()
  const { chartParamsNumber, setChatParamsNumber } = useChatParamsNumber()
  const attendanceParams = isHour ? chartParamsHour : chartParamsNumber
  const setAttendanceParams = isHour ? setChatParamsHour : setChatParamsNumber
